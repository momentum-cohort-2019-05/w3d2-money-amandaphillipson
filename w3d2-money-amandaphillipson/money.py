class DifferentCurrencyError(Exception):
    ...
    # except DifferentCurrencyError as e:
    except DifferentCurrencyError as:
        print("Error: Cannot add or subtract using a different currency.")
        # print(type(e))
        # print(e)
        # pass
...
# NOTES:
#   object.method (self.currency)
#   __init__ (initiate new class)
#   Classes are named with "camel case" - Capitol lettser and no punctuaion/space inbetween.